...
#define TPD_GES_KEY_LEFT                            0x20
#define TPD_GES_KEY_RIGHT                           0x21
#define TPD_GES_KEY_UP                              0x22
#define TPD_GES_KEY_DOWN                            0x23
#define TPD_GES_KEY_DOUBLECLICK                     0x24
/*
* add by lava for control gesture on/off
*/
#define LAVA_GESTURE_NODE_EN                        1
#endif
...
#endif
#define CONFIG_GTP_HAVE_TOUCH_KEY
#ifdef CONFIG_GTP_HAVE_TOUCH_KEY
//#define GTP_KEY_TAB	 {KEY_MENU, KEY_HOMEPAGE, KEY_VOLUMEDOWN, KEY_VOLUMEUP}
#define GTP_KEY_TAB	 {KEY_BACK, KEY_HOMEPAGE, KEY_MENU, KEY_SEARCH}
#define GTP_MAX_KEY_NUM  4
#endif

/****************************PART3:OTHER define*********************************/
#define GTP_DRIVER_VERSION          "V1.6<2016/07/28>"
...
//lava yanrenjie add begin
void gt1x_gesture_mode_set(int enable);
u8 gt1x_gesture_mode_get(void);
#define ENABLE                              1
#define DISABLE                             0
//lava yanrenjie add end
#endif
