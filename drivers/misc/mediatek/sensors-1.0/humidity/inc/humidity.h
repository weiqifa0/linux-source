...
struct hmdy_context {
	...
	struct sensor_attr_t hmdy_mdev;
	struct sensor_attr_t temp_mdev;
	struct work_struct report_hmdy;
	struct work_struct report_temp;
	struct mutex hmdy_op_mutex;
	atomic_t delay_hmdy;
	atomic_t delay_temp;
	atomic_t wake;
	struct timer_list timer_hmdy;
	...
	bool is_hmdy_active_nodata;
	bool is_temp_active_nodata;
	bool is_hmdy_active_data;
	bool is_temp_active_data;
	bool is_hmdy_first_data_after_enable;
	bool is_temp_first_data_after_enable;
	bool is_hmdy_polling_run;
	bool is_temp_polling_run;
	bool is_hmdy_batch_enable;
	bool is_temp_batch_enable;
};
...
extern int temp_data_report(int value, int status);
