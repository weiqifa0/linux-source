...
#undef DEBUG_CAMERA_GC5025
//#define DEBUG_CAMERA_GC5025 
#ifdef DEBUG_CAMERA_GC5025
...
static imgsensor_info_struct imgsensor_info = {
       ...
       .checksum_value = 0x68d49e6a,//0xf7375923,        //checksum value for Camera Auto Test
...
static void set_dummy(void)
{
	...
	vb = imgsensor.frame_length*2 - basic_line;
...
static kal_uint32 get_default_framerate_by_scenario(MSDK_SCENARIO_ID_ENUM scenario_id, MUINT32 *framerate) // get default framerate
{
    LOG_INF("scenario_id = %d\n", scenario_id); // 0
	if (framerate == NULL) {
		return ERROR_NONE;
