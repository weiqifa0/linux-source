					      ...
					      UINT32 *pvx, UINT32 *pvy, UINT32 pvw, UINT32 pvh)
{
	...
	*pvy = pvh * my / mh;
	LOG_INF
	    ("mapping middlware x[%d],y[%d], [%d X %d]\n\t\tto x[%d],y[%d],[%d X %d]\n ", mx, my,
	     mw, mh, *pvx, *pvy, pvw, pvh);
}
...
void mapCoordinate(UINT32 linenum, UINT32 rownum, UINT32 *sectionlinenum, UINT32 *sectionrownum)
{
	...
	*sectionrownum = clampSection(rownum - 1, 0, AE_HORIZONTAL_BLOCKS - 1);
	LOG_INF("mapCoordinate from[%d][%d] to[%d][%d]\n",
...
void OV5645_FOCUS_Set_AE_Window(UINT32 zone_addr)
{
	...
	printAE_2_ARRAY();
	writeAEReg();
	LOG_INF("exit OV5645_FOCUS_Set_AE_Window function\n");
}
...
{
	LOG_INF("enter OV5645MIPISetDummy function:\n ");
	...
	LOG_INF("exit OV5645MIPISetDummy function:\n ");
}				/* OV5645MIPI_set_dummy */
...
static void OV5645MIPIWriteShutter(kal_uint32 shutter)
{
	...
	LOG_INF("enter OV5645MIPIWriteShutter function:\n ");
	if (shutter < 1)
		shutter = 1;
	...
	LOG_INF("exit OV5645MIPIWriteShutter function:\n ");
...
{
	shutter *= 16;
	LOG_INF("enter OV5645MIPIWriteExpShutter function:\n ");
	OV5645MIPI_write_cmos_sensor(0x3502, (shutter & 0x00FF));	/* AEC[7:0] */
	OV5645MIPI_write_cmos_sensor(0x3501, ((shutter & 0x0FF00) >> 8));	/* AEC[15:8] */
	OV5645MIPI_write_cmos_sensor(0x3500, ((shutter & 0xFF0000) >> 16));
	LOG_INF("exit OV5645MIPIWriteExpShutter function:\n ");
}				/* OV5645MIPI_write_shutter */
...
{
	LOG_INF("enter OV5645MIPIWriteExtraShutter function:\n ");
	...
	LOG_INF("exit OV5645MIPIWriteExtraShutter function:\n ");
}				/* OV5645MIPI_write_shutter */
...
static kal_uint32 OV5645MIPIReadShutter(void)
{
	...
	LOG_INF("enter OV5645MIPIReadShutter function:\n ");
	...
	spin_unlock(&ov5645mipi_drv_lock);
	LOG_INF("exit OV5645MIPIReadShutter function:\n ");
...
static kal_uint32 OV5645MIPIReadExtraShutter(void)
{
	...
	LOG_INF("enter OV5645MIPIReadExtraShutter function:\n ");
	...
	spin_unlock(&ov5645mipi_drv_lock);
	LOG_INF("exit OV5645MIPIReadExtraShutter function:\n ");
...
static kal_uint32 OV5645MIPIReadSensorGain(void)
{
	...
	LOG_INF("enter OV5645MIPIReadSensorGain function:\n ");
	sensor_gain = (OV5645MIPIYUV_read_cmos_sensor(0x350B) & 0xFF);
	LOG_INF("exit OV5645MIPIReadSensorGain function:\n ");
	return sensor_gain;
}				/* OV5645MIPIReadSensorGain */
...
static void OV5645MIPI_set_AE_mode(kal_bool AE_enable)
{
	...
	LOG_INF("enter OV5645MIPI_set_AE_mode function:\n ");
	...
	LOG_INF("exit OV5645MIPI_set_AE_mode function:\n ");
}
...
static void OV5645MIPI_set_AWB_mode(kal_bool AWB_enable)
{
	...
	LOG_INF("enter OV5645MIPI_set_AWB_mode function:\n ");
	...
	LOG_INF("exit OV5645MIPI_set_AWB_mode function:\n ");
}
...
void OV5645MIPI_night_mode(kal_bool enable)
{
	...
	spin_unlock(&ov5645mipi_drv_lock);
	LOG_INF("exit OV5645MIPI_night_mode function:\n ");
}				/* OV5645MIPI_night_mode */
...
static kal_uint32 OV5645MIPI_GetSensorID(kal_uint32 *sensorID)
{
	...
	LOG_INF("enter OV5645MIPI_GetSensorID function:\n ");
	...
	LOG_INF("exit OV5645MIPI_GetSensorID function:\n");
	return ERROR_NONE;
}
...
static void OV5645MIPIInitialSetting(void)
{
	...
	LOG_INF("enter OV5645MIPIInitialSetting function:\n ");
	...
	OV5645MIPI_write_cmos_sensor(0x3a19, 0xf8);	/* ; gain ceiling 0x60 */
	...
	OV5645MIPI_write_cmos_sensor(0x5000, 0xa7);	/* ; Lenc on, raw gamma on, BPC on, WPC on */
	OV5645MIPI_write_cmos_sensor(0x5001, 0xa3);	/* ; SDE on, scale off, UV adjust off */
	...
	LOG_INF("exit OV5645MIPIInitialSetting function:\n ");
...
static void OV5645MIPIPreviewSetting_SVGA(void)
{
	...
	LOG_INF("enter OV5645MIPIPreviewSetting_SVGA function:\n ");
	...
	OV5645MIPISensor.PreviewPclk = 560;
	spin_unlock(&ov5645mipi_drv_lock);
	LOG_INF("exit OV5645MIPIPreviewSetting_SVGA function:\n ");
}
...
static void OV5645MIPIFullSizeCaptureSetting(void)
{
	...
	LOG_INF("enter OV5645MIPIFullSizeCaptureSetting function:\n ");
	OV5645MIPI_write_cmos_sensor(0x300e, 0x45);	/* ; MIPI 2 lane */
	OV5645MIPI_write_cmos_sensor(0x3034, 0x18);	/* PLL, MIPI 8-bit mode */
	...
	spin_unlock(&ov5645mipi_drv_lock);
	LOG_INF("exit OV5645MIPIFullSizeCaptureSetting function:\n ");
}
...
static void OV5645MIPISetHVMirror(kal_uint8 Mirror, kal_uint8 Mode)
{
	...
	LOG_INF("enter OV5645MIPISetHVMirror function:\n ");
	LOG_INF("enter OV5645MIPISetHVMirror %d %d:\n ", Mode, Mirror);
	...
	LOG_INF("exit OV5645MIPISetHVMirror function:\n ");
}
...
{
	LOG_INF("enter OV5645_FOCUS_OVT_AFC_Constant_Focus function:\n ");
	OV5645MIPI_write_cmos_sensor(0x3023, 0x01);
	OV5645MIPI_write_cmos_sensor(0x3022, 0x04);
	LOG_INF("exit OV5645_FOCUS_OVT_AFC_Constant_Focus function:\n ");
}
...
{
	LOG_INF("enter OV5645_FOCUS_OVT_AFC_Single_Focus function:\n ");
	OV5645MIPI_write_cmos_sensor(0x3023, 0x01);
	OV5645MIPI_write_cmos_sensor(0x3022, 0x81);
	mDELAY(50);
	OV5645MIPI_write_cmos_sensor(0x3022, 0x03);
	LOG_INF("exit OV5645_FOCUS_OVT_AFC_Single_Focus function:\n ");
}
...
{
	LOG_INF
	    ("enter OV5645_FOCUS_Get_AE_Max_Num_Metering_Areas function:\n ");
	*pFeatureReturnPara32 = 1;
	LOG_INF(" *pFeatureReturnPara32 = %d\n", *pFeatureReturnPara32);
	LOG_INF
	    ("exit OV5645_FOCUS_Get_AE_Max_Num_Metering_Areas function:\n ");
}
...
static void OV5645_FOCUS_OVT_AFC_Touch_AF(UINT32 x, UINT32 y)
{
	...
	LOG_INF("exit OV5645_FOCUS_OVT_AFC_Touch_AF function:\n ");
}
...
static void OV5645_FOCUS_Set_AF_Window(UINT32 zone_addr)
{
	...
	LOG_INF("exit OV5645_FOCUS_Set_AF_Window function:\n ");
}
...
static void OV5645_FOCUS_OVT_AFC_Get_AF_Status(UINT32 *pFeatureReturnPara32)
{
	...
	*pFeatureReturnPara32 = SENSOR_AF_IDLE;
	...
	mDELAY(1);
	LOG_INF
	    ("enter OV5645_FOCUS_OVT_AFC_Get_AF_Status function:state_3028=%d,state_3029=%d\n",
	...
	LOG_INF
	    ("exit OV5645_FOCUS_OVT_AFC_Get_AF_Status function:state_3028=%d,state_3029=%d\n",
	     state_3028, state_3029);
}
...
static void OV5645WBcalibattion(kal_uint32 color_r_gain, kal_uint32 color_b_gain)
{
	...
	LOG_INF("exit OV5645WBcalibattion function:\n ");
}
...
UINT32 OV5645MIPIOpen(void)
{
	...
	LOG_INF("enter OV5645MIPIOpen function:\n ");
	...
	OV5645MIPIInitialSetting();
	OV5645_FOCUS_OVT_AFC_Init();
	LOG_INF("exit OV5645MIPIOpen function:\n ");
	return ERROR_NONE;
}				/* OV5645MIPIOpen() */
			 ...
			 MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	LOG_INF("enter OV5645MIPIPreview function:\n ");
	...
	LOG_INF("exit OV5645MIPIPreview function:\n ");
	return ERROR_NONE;
			 ...
			 MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	LOG_INF("enter OV5645MIPICapture function:\n ");
	...
	LOG_INF("exit OV5645MIPICapture function:\n ");
	return ERROR_NONE;
}				/* OV5645MIPICapture() */

UINT32 OV5645MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
	LOG_INF("enter OV5645MIPIGetResolution function:\n ");
	...
	LOG_INF("exit OV5645MIPIGetResolution function:\n ");
	return ERROR_NONE;
}				/* OV5645MIPIGetResolution() */

UINT32 OV5645MIPIGetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId, MSDK_SENSOR_INFO_STRUCT *pSensorInfo,
			 MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	LOG_INF("enter OV5645MIPIGetInfo function:\n ");
	switch (ScenarioId) {
	case MSDK_SCENARIO_ID_CAMERA_ZSD:
	...
	pSensorInfo->SensorOutputDataFormat = SENSOR_OUTPUT_FORMAT_YUYV;	/* YVYU;//SENSOR_OUTPUT_FORMAT_UYVY; */
	...
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		...
		pSensorInfo->MIPIDataLowPwr2HighSpeedSettleDelayCount = SETTLE_DELAY;
	...
	LOG_INF("exit OV5645MIPIGetInfo function:\n ");
	return ERROR_NONE;
}				/* OV5645MIPIGetInfo() */
...
UINT32 OV5645MIPIControl(MSDK_SCENARIO_ID_ENUM ScenarioId,
			 ...
			 MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
	LOG_INF("enter OV5645MIPIControl function:\n ");
	spin_lock(&ov5645mipi_drv_lock);
	...
	LOG_INF("exit OV5645MIPIControl function:\n ");
	return ERROR_NONE;
}				/* OV5645MIPIControl() */
...
{
	LOG_INF("enter OV5645MIPI_set_param_wb function:\n ");
	/* spin_lock(&ov5645mipi_drv_lock); */
	...
	spin_unlock(&ov5645mipi_drv_lock);
	LOG_INF(" OV5645MIPI_set_param_wb %d\n", para);

	LOG_INF("exit OV5645MIPI_set_param_wb function:\n");
	return TRUE;
}				/* OV5645MIPI_set_param_wb */

BOOL OV5645MIPI_set_param_effect(UINT16 para)
{
	LOG_INF("enter OV5645MIPI_set_param_effect function:\n");
	switch (para) {
	case MEFFECT_OFF:
		OV5645MIPI_write_cmos_sensor(0x3212, 0x03);
		OV5645MIPI_write_cmos_sensor(0x5580, 0x06);
	...
	LOG_INF("exit OV5645MIPI_set_param_effect function:\n ");
	mDELAY(100);
	return KAL_FALSE;
...
{
	LOG_INF("enter OV5645MIPI_set_param_banding function:\n");
	switch (para) {
	...
	LOG_INF("exit OV5645MIPI_set_param_banding function:\n");
	return TRUE;
}				/* OV5645MIPI_set_param_banding */

BOOL OV5645MIPI_set_param_exposure(UINT16 para)
{
	LOG_INF("enter OV5645MIPI_set_param_exposure function:\n");
	switch (para) {
	case AE_EV_COMP_30:
		OV5645MIPI_write_cmos_sensor(0x3212, 0x03);
	...
	LOG_INF("exit OV5645MIPI_set_param_exposure function:\n");
	return TRUE;
...
{
	LOG_INF("enter OV5645MIPIYUVSensorSetting function:\n");
	switch (iCmd) {
	case FID_SCENE_MODE:
	...
	LOG_INF("exit OV5645MIPIYUVSensorSetting function:\n ");
	return TRUE;
}				/* OV5645MIPIYUVSensorSetting */

UINT32 OV5645MIPIYUVSetVideoMode(UINT16 u2FrameRate)
{
	LOG_INF("enter OV5645MIPIYUVSetVideoMode function:\n ");
	if (u2FrameRate == 30) {
		/* ;OV5645MIPI 1280x960,30fps */
		/* 56Mhz, 224Mbps/Lane, 2Lane. */
		LOG_INF
		    ("OV5645MIPIYUVSetVideoMode enter u2FrameRate == 30 setting  :\n ");
		...
		LOG_INF
		    ("OV5645MIPIYUVSetVideoMode exit u2FrameRate == 30 setting  :\n ");
		...
		OV5645MIPI_write_cmos_sensor(0x350d, 0x00);	/*  */
		LOG_INF
		    ("OV5645MIPIYUVSetVideoMode exit u2FrameRate == 20 setting:\n");
	} else if (u2FrameRate == 15) {
		/* ;OV5645MIPI 1280x960,15fps */
		/* 28Mhz, 112Mbps/Lane, 2Lane. */
		LOG_INF
		    ("OV5645MIPIYUVSetVideoMode enter u2FrameRate == 15 setting  :\n ");
		...
		OV5645MIPI_write_cmos_sensor(0x350d, 0x00);	/*  */
		LOG_INF
		    ("OV5645MIPIYUVSetVideoMode exit u2FrameRate == 15 setting  :\n ");
	} else {
		LOG_INF("Wrong frame rate setting\n");
	}
	LOG_INF("exit OV5645MIPIYUVSetVideoMode function:\n ");
	return TRUE;
}
...
UINT32 OV5645MIPIMaxFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId, MUINT32 frameRate)
{
	...
	LOG_INF("OV5645MIPIMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",
			   scenarioId, frameRate);
	LOG_INF("enter OV5645MIPIMaxFramerateByScenario function:\n ");
	switch (scenarioId) {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		pclk = 56000000;
	...
	LOG_INF("exit OV5645MIPIMaxFramerateByScenario function:\n ");
	return ERROR_NONE;
}

UINT32 OV5645MIPIGetDefaultFramerateByScenario(MSDK_SCENARIO_ID_ENUM scenarioId,
					       MUINT32 *pframeRate)
{
	LOG_INF
	    ("enter OV5645MIPIGetDefaultFramerateByScenario function:\n ");
	switch (scenarioId) {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
	case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
		*pframeRate = 300;
	...
	LOG_INF("exit OV5645MIPIGetDefaultFramerateByScenario function:\n ");
	return ERROR_NONE;
}

void OV5645MIPI_get_AEAWB_lock(UINT32 *pAElockRet32, UINT32 *pAWBlockRet32)
{
	LOG_INF("enter OV5645MIPI_get_AEAWB_lock function:\n ");
	*pAElockRet32 = 1;
	*pAWBlockRet32 = 1;
	LOG_INF("OV5645MIPI_get_AEAWB_lock,AE=%d,AWB=%d\n", *pAElockRet32,
			   *pAWBlockRet32);
	LOG_INF("exit OV5645MIPI_get_AEAWB_lock function:\n ");
}
...
void OV5645_MIPI_GetExifInfo(UINT32 exifAddr)
{
	...
	LOG_INF("exit OV5645_MIPI_GetExifInfo function:\n ");
}
...
/* --------end */
UINT32 OV5645MIPIFeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId, UINT8 *pFeaturePara,
				UINT32 *pFeatureParaLen)
{
	...
	case SENSOR_FEATURE_GET_PERIOD:
		...
		case MSDK_SCENARIO_ID_CAMERA_ZSD:
			*pFeatureReturnPara16++ =
			    OV5645MIPI_FULL_PERIOD_PIXEL_NUMS + OV5645MIPISensor.CaptureDummyPixels;
			*pFeatureReturnPara16 =
			    OV5645MIPI_FULL_PERIOD_LINE_NUMS + OV5645MIPISensor.CaptureDummyLines;
			*pFeatureParaLen = 4;
			break;
		default:
			*pFeatureReturnPara16++ =
			    OV5645MIPI_PV_PERIOD_PIXEL_NUMS + OV5645MIPISensor.PreviewDummyPixels;
			*pFeatureReturnPara16 =
			    OV5645MIPI_PV_PERIOD_LINE_NUMS + OV5645MIPISensor.PreviewDummyLines;
			*pFeatureParaLen = 4;
			break;
		}
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_GET_PERIOD\n"); */
	...
	case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
		...
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ\n"); */
		/* *pFeatureReturnPara32 = OV5645MIPISensor.PreviewPclk * 1000 *100;      //unit: Hz */
		/* *pFeatureParaLen=4; */
		break;
	case SENSOR_FEATURE_SET_ESHUTTER:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_ESHUTTER\n"); */
		break;
	case SENSOR_FEATURE_SET_NIGHTMODE:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_NIGHTMODE\n"); */
		OV5645MIPI_night_mode((BOOL) *pFeatureData16);
		break;
	case SENSOR_FEATURE_SET_GAIN:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_GAIN\n"); */
		break;
/* mod for flash */
...
/* end */
	case SENSOR_FEATURE_SET_FLASHLIGHT:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_FLASHLIGHT\n"); */
		break;
	case SENSOR_FEATURE_SET_ISP_MASTER_CLOCK_FREQ:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_ISP_MASTER_CLOCK_FREQ\n"); */
		break;
	case SENSOR_FEATURE_SET_REGISTER:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_REGISTER\n"); */
		OV5645MIPI_write_cmos_sensor(pSensorRegData->RegAddr, pSensorRegData->RegData);
		break;
	case SENSOR_FEATURE_GET_REGISTER:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_GET_REGISTER\n"); */
		pSensorRegData->RegData = OV5645MIPIYUV_read_cmos_sensor(pSensorRegData->RegAddr);
		break;
	case SENSOR_FEATURE_GET_CONFIG_PARA:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_GET_CONFIG_PARA\n"); */
	...
	case SENSOR_FEATURE_GET_ENG_INFO:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET/get_CCT_xxxx ect\n"); */
		break;
	case SENSOR_FEATURE_GET_GROUP_COUNT:
		*pFeatureReturnPara32++ = 0;
		*pFeatureParaLen = 4;
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_GET_GROUP_COUNT\n"); */
		break;
	case SENSOR_FEATURE_GET_LENS_DRIVER_ID:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_GET_LENS_DRIVER_ID\n"); */
	...
	case SENSOR_FEATURE_CHECK_SENSOR_ID:
		LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_CHECK_SENSOR_ID\n");
		OV5645MIPI_GetSensorID(pFeatureData32);
		break;
	case SENSOR_FEATURE_SET_YUV_CMD:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_YUV_CMD\n"); */
		OV5645MIPIYUVSensorSetting((FEATURE_ID) *pFeatureData32, *(pFeatureData32 + 1));
		break;
	case SENSOR_FEATURE_SET_VIDEO_MODE:
		/* LOG_INF("OV5645MIPIFeatureControl:SENSOR_FEATURE_SET_VIDEO_MODE\n"); */
	...
	case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
		OV5645MIPIMaxFramerateByScenario((MSDK_SCENARIO_ID_ENUM) *pFeatureData32,
						 *(pFeatureData32 + 1));
		break;
	case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
		OV5645MIPIGetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM) *pFeatureData32,
	...
	default:
		LOG_INF("OV5645MIPIFeatureControl:default\n");
		break;
	}
	LOG_INF("exit OV5645MIPIFeatureControl function:\n ");
	return ERROR_NONE;
