...
#define OV5645MIPI_PV_PERIOD_PIXEL_NUMS		(1896)	/* (1896)  Default preview line length HTS */
#define OV5645MIPI_PV_PERIOD_LINE_NUMS		(984)	/* (984)   Default preview frame length  VTS */
